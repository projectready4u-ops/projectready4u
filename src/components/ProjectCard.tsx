        ...
        <div className="p-4">
          ...
          <div className="flex gap-2">
            <Link href={`/projects/${project.slug}`} className="flex-1">
              <button
                className="w-full px-4 py-2 rounded-md font-semibold text-white bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 active:from-violet-800 active:to-indigo-800 transition-all duration-200"
              >
                View Details
              </button>
            </Link>
